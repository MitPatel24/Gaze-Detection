...
def positionEstimator(cropped_eye):
    ...
    ret, threshed_eye = cv.threshold(median_blur, 120, 255, cv.THRESH_BINARY)
...
with map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            if eye_position_right == "RIGHT" and pygame.mixer.get_busy() == 0 and \
                    counter_right < 1:
                # starting counter 
                counter_right += 1
                # resetting counters 
            ...
            if eye_position_right == "CENTER" and eye_position_left=="CENTER" and eye_position_left=="CENTER":
                # starting Counter 
                counter_center += 1
                # resetting counters 
                counter_right = 0
            ...
            if eye_position_right == "LEFT"  and pygame.mixer.get_busy() == 0 and \
                    counter_left \
                    < 1:
                counter_left += 1
                # resetting counters 
